...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-ik-#*9^44ixh!88!%(y7ime=zzyjk4pqcoe9d-tsc^5rzpy^(&')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=False, cast=bool)  # Voltando para False para produção
...
if DATABASE_URL:
    ...
    # Adicionar configurações SSL para PostgreSQL em produção
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'contato@regionalveiculos.com.br'
